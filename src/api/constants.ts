...
export const EXPERIENCES: Experience[] = [
	{
		...
		description:
			"Developing full stack web apps for RBC Borealis: RBC's flagship AI and data innovation initiative.",
		image: rbcBorealis,
		fromDate: 'Apr 2024',
		toDate: 'Present',
	...
	},
	{
		...
		description:
			'Developed full stack web applications for one of the largest experiential learning providers in North America.',
		image: orbis,
